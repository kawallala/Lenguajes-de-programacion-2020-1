...
(test (parse '{with {x : Num 3} x}) (app (fun 'x (TNum) (id 'x) #f) (num 3)))
...
(test (typed-compile '{with {x : Num {{fun {x : Num} {+ x x}} 3}} {+ x 5}}) (list
                                                                             (INT-CONST 3)
                                                                             (CLOSURE (list (ACCESS 0) (ACCESS 0) (ADD) (RETURN)))
                                                                             (APPLY)
                                                                             (CLOSURE (list (INT-CONST 5) (ACCESS 0) (ADD) (RETURN)))
                                                                             (APPLY)))
